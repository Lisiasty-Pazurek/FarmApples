...
[System.Serializable]
    ...
    public class MatchMaker : NetworkBehaviour {
        ...
        readonly public SyncList<Match> matches = new SyncList<Match> ();
        readonly public SyncList<String> matchIDs = new SyncList<String> ();

        [SerializeField] int maxMatchPlayers = 10;
        [SerializeField] private GameObject prefabLevelManager;
...
//            playerIndex = 0;
        ...
        {
            Debug.Log("Initiating level in: " +_matchID);
            levelController = lvlManager.GetComponent<LevelController>();
            levelController.levelMatchID = _matchID;
